...
void	init_settings_menu(void)
{
	...
	menu->chk_res_min = create_checkbox(NULL, ivec2_zero(), chk_select_res_min, chk_unselect_res_min);
	menu->chk_res_med = create_checkbox(NULL, ivec2_zero(), chk_select_res_med, chk_unselect_res_med);
	menu->chk_res_high = create_checkbox(NULL, ivec2_zero(), chk_select_res_high, chk_unselect_res_high);
	menu->chk_res_fullscreen = create_checkbox(NULL, ivec2_zero(), chk_select_res_fullscreen, chk_unselect_res_fullscreen);
...
static void	init_positions(t_ui_settings_menu *menu)
{
	...
	uic_padding_down(&menu->chk_res_min.infos, 50);
	uic_padding_down(&menu->chk_res_med.infos, 50);
	uic_padding_down(&menu->chk_res_high.infos, 50);
	uic_padding_down(&menu->chk_res_fullscreen.infos, 50);
	uic_below(&menu->chk_res_min.infos, &menu->slid_fov.infos);
...
static void	init_textures(t_ui_settings_menu *menu)
{
	menu->chk_res_min.tex_id = new_texture(200, 100);
	clear_texture(RED, menu->chk_res_min.tex_id);
	render_text_tex("960x540", DEFAULT_FONT,
		text_center("960x540", DEFAULT_FONT, 22, ivec2(100, 50)),
	...
	menu->chk_res_med.tex_id = new_texture(200, 100);
	clear_texture(RED, menu->chk_res_med.tex_id);
	render_text_tex("1280x720", DEFAULT_FONT,
		text_center("1280x720", DEFAULT_FONT, 22, ivec2(100, 50)),
	...
	menu->chk_res_high.tex_id = new_texture(200, 100);
	clear_texture(RED, menu->chk_res_high.tex_id);
	render_text_tex("1920x1080", DEFAULT_FONT,
		text_center("1920x1080", DEFAULT_FONT, 22, ivec2(100, 50)),
		ivec2(22, menu->chk_res_high.tex_id));
	finish_new_texture(menu->chk_res_high.tex_id);
	menu->chk_res_high.infos.size = get_texture_size(menu->chk_res_high.tex_id);
	menu->chk_res_fullscreen.tex_id = new_texture(200, 100);
	clear_texture(RED, menu->chk_res_fullscreen.tex_id);
	render_text_tex("fullscreen", DEFAULT_FONT,
		text_center("fullscreen", DEFAULT_FONT, 22, ivec2(100, 50)),
